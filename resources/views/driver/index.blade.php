                    ...
                    @foreach($users as $key => $user)
                        <tr>
                            ...
                            <td>
                                ...
                                @can('users.write')
                                    <a href="{{ route('user.edit', $user->id) }}" class="btn btn-primary"><i class="fa fa-pen"></i></a>
                                    <button class="btn btn-danger" type="button" onclick="commonDelete(`{{ route('user.destroy', $user->id) }}`)"><i class="fa fa-trash"></i></button>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
