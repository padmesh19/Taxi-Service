...
<div class="align-content-sm-end">
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ route('driver.index') }}"><i class="fas fa-home"></i></a></li>
    </ol>
</div>
...
<div class="card col-sm-8 mx-auto">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{URL('/driver',['user' => $user->id]) }}" method="post">
            @csrf
            <div class="form-group mb-3">
                <label for="name" class="mb-2"> Driver Name</label>
            ...
            <div class="form-group mb-3">
                <label for="email" class="mb-2">Driver Email</label>
            ...
            <div style="margin-top: 20px;">
                <a href="{{ route('driver.index') }}" class="btn btn-primary">Cancel</a>
