        ...
        <table id="datatablesSimple">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $rideRequest->distance }}</td>
                    <td>{{ $rideRequest->pickTime }}</td>
                    <td>{{ $rideRequest->payments->amount |null }}</td>
                    ...
                    <td>
                        ...
                        <form action="{{ route('ride.destroy', $rideRequest->id) }}" method="post">
                            ...
                            <a href="{{ route('ride.edit', $rideRequest->id) }}" class="btn btn-primary"><i class="fa fa-pen"></i></a>
                            <button class="btn btn-danger" type="submit"><i class="fa fa-trash"></i></button>
                        </form>
                        @endcan
                        <a href="{{ route('payment.show', $rideRequest->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        @can('rides.accept')
                            <a href="{{ route('ride.accept', $rideRequest->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                            <a href="{{ route('ride.reject', $rideRequest->id) }}" class="btn btn-danger"><i class="fa fa-pen"></i></a>
                            <a href="{{ route('payment.create', $rideRequest->id) }}" class="btn btn-success"><i class="fa fa-pen"></i></a>
                        @endcan
                    </td>
                </tr>
                @endforeach
